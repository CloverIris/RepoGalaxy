...
public sealed class UserService : IUserService
{
    ...
    private static User Map(UserEntity e) => new() { Id = e.Id, GitHubId = e.GitHubId, Login = e.Login, DisplayName = e.DisplayName ?? string.Empty, AvatarUrl = e.AvatarUrl ?? string.Empty, Bio = e.Bio ?? string.Empty, Company = e.Company ?? string.Empty, Location = e.Location ?? string.Empty, Blog = e.Blog ?? string.Empty, TwitterUsername = e.TwitterUsername ?? string.Empty, ProfileUrl = e.ProfileUrl ?? string.Empty, PublicRepos = e.PublicRepos, Followers = e.Followers, Following = e.Following, CreatedAt = e.CreatedAt, LastLoginAt = e.LastLoginAt };
